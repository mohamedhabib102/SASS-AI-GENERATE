...
export default function ContactUs() {
  ...
  const subjects=useMemo(()=> [
    {labelKey: 'contactUs.form.selectSubject',value: ''},
    {labelKey: 'contactUs.form.complaint',value: 'COMPLAINT'},
    {labelKey: 'contactUs.form.request',value: 'REQUEST'},
    {labelKey: 'contactUs.form.other',value: 'OTHER'},
  ],[])
              ...
              <form onSubmit={formik.handleSubmit}>
                <div className="flex flex-col gap-5">
                  ...
                  <div className="subject flex flex-col gap-2">
                    ...
                    >
                    {t("contactUs.form.subject_label")}
                    </label>
                    <select name="subject"
                    id="subject"
                  ...
                  className="w-full text-[16px] cursor-pointer bg-primary hover:bg-violet-700 active:scale-95 text-white font-semibold py-3 rounded-lg flex items-center justify-center gap-2 transition-all duration-200 shadow-md shadow-violet-200">
                    {
                      isPending ? t("contactUs.form.sending") : t("contactUs.form.submit")
                    }
                  </button>
                </div>
              </form>
