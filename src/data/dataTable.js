        ...
        rows: [
          {
            ...
            values: {
              enterprise: { type: "text", value: "غير محدود" },
              pro: { type: "text", value: "حتى 200" },
              basic: { type: "text", value: "حتى 50" },
            },
          },
          {
            type: "row",
            ...
            values: {
              enterprise: { type: "text", value: "غير محدود" },
              pro: { type: "text", value: "غير محدود" },
              basic: { type: "text", value: "1" },
            },
          },
          {
            type: "row",
          ...
          },
          {
            ...
            values: {
              enterprise: { type: "text", value: "مخصصة" },
              pro: { type: "text", value: "متقدمة" },
              basic: { type: "text", value: "أساسية" },
            },
          },
          {
            type: "row",
        ...
        rows: [
          {
            ...
            values: {
              enterprise: { type: "text", value: "مخصص بالكامل" },
              pro: { type: "text", value: "متقدم" },
              basic: { type: "text", value: "أساسي" },
            },
          },
          {
            type: "row",
