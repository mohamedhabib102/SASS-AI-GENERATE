...
const sections =
  data?.data?.length > 0? data.data.slice(0, 3): fallbackSections;
  return (
              ...
              >
                <Animate direction="up" delay={0.2}>
                  ...
                  {section.button_text && (
                    <Button
                      variant="secondary"
                      className="bg-secondary hover:bg-orange-600 text-white font-semibold text-base h-auto py-3 px-8 rounded-xl cursor-pointer transition-colors duration-200 border-none shadow-md animate-none"
                    >
                      {section.button_text}
                    </Button>
                  )}
