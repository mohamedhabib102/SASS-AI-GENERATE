          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="lg:block hidden absolute top-4 left-8 z-20 md:w-16 md:h-20 animate-pulse">
                ...
                <span className="lg:block hidden absolute top-5 right-24 z-20 w-8 h-8 md:w-9 md:h-9">
                ...
                <span className="lg:block hidden absolute bottom-4 left-10/12 -translate-x-1/2 z-20 w-44 h-16 md:w-52 md:h-18">
                ...
                <div className="absolute flex justify-center items-center -rotate-12 w-full h-full top-[43%] left-1/2 -translate-1/2 z-10 transition-transform duration-300">
                  <img
                    ...
                    className="lg:w-96 lg:h-96 w-72 h-72 object-cover"
                    style={{
                      clipPath:
          ...
          >
            ...
            {btnText && (
              ...
              >
                <Button
                  onClick={onBtnClick}
                  className="bg-secondary hover:bg-secondary/80 text-white font-semibold text-base px-8 py-3 h-auto rounded-xl transition-all duration-200 cursor-pointer"
                >
                  {btnText}
                </Button>
              </Animate>
