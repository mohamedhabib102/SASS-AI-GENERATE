...
const AboutHero = () => {
  ...
  return (
    <section className="relative flex items-center justify-center min-h-120 md:min-h-137.5 lg:min-h-[600px] w-full text-white py-16 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-linear-to-b from-[#0000004D] via-[#FFFFE94D] to-[#00000066] z-10" />
        ...
        <div className="flex flex-col items-center justify-center text-center max-w-4xl mx-auto">
          ...
          <Animate direction="up" triggerOn="mount" duration={0.6} delay={0.4}>
            <Button
              ...
              className="bg-primary hover:bg-primary-dark text-white font-semibold text-base md:text-lg h-auto py-2.5 px-10 rounded-lg cursor-pointer transition-all duration-300 shadow-lg hover:shadow-primary/20 hover:scale-[1.02] border-none"
            >
