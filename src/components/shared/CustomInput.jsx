    ...
    const CustomInput = ({
        ...
        <label htmlFor={id} className={`${lang === "ar" ? "text-right" : "text-left"} text-black text-lg font-semibold`}>{labelContent}</label>
        ...
        <div className="relative">
            ...
            {icon && <span className={`absolute ${lang === 'en' ? 'left-2' : 'right-2'} text-[#9E9E9E] top-1/2 -translate-y-1/2`}>{<IconBase size={18} />}</span>}
