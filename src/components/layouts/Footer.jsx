...
const Footer = () => {
  ...
  const quickLinks = [
    { id: 1, label: t("footer.quickLinks.home"), to: "/" },
    { id: 2, label: t("footer.quickLinks.about"), to: "/about" },
    { id: 3, label: t("footer.quickLinks.services"), to: "/services" },
    { id: 4, label: t("footer.quickLinks.testimonials"), to: "/testimonials" },
    { id: 5, label: t("footer.quickLinks.pricing"), to: "/pricing" },
  ];
  ...
  const ourServices = [
    ...
    },
    {
      ...
      to: "/services/ads-campaigns",
    },
    { id: 4, label: t("footer.services.contactUs"), to: "/contact" },
    { id: 5, label: t("footer.services.faq"), to: "/faq" },
  ];
