        ...
        min-h-screen`}>
                ...
                <div className="w-full ">
                    ...
                    <div className="space-y-2">
                        <h1 className="text-2xl lg:text-[2.2rem] font-bold text-white leading-tight">
                            مرحباً بك في
                            <span className="block text-[#F56E14] mt-2 font-bold">منصة ماركيفا لإدارة الخدمات التسويقية</span>
                        </h1>
                    </div>
                    ...
                    <ul className="space-y-4">
                        ...
                        <li className="flex items-center gap-3">
                            ...
                            <span className="text-white/90 text-sm lg:text-base font-medium">جمع ذكي للعملاء المحتملين.</span>
                        </li>
                        {/* Bullet 2 */}
                        <li className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-[#F0E8DB] flex items-center justify-center shrink-0">
                            ...
                            <span className="text-white/90 text-sm lg:text-base font-medium">لوحة تحكم ترصد الحملات التسويقية لحظة بلحظة.</span>
                        </li>
                        {/* Bullet 3 */}
                        <li className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-[#F0E8DB] flex items-center justify-center shrink-0">
                            ...
                            <span className="text-white/90 text-sm lg:text-base font-medium">تحليل وتصنيف بالذكاء الاصطناعي.</span>
                        </li>
                        {/* Bullet 4 */}
                        <li className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-[#F0E8DB] flex items-center justify-center shrink-0">
                            ...
                            <span className="text-white/90 text-sm lg:text-base font-medium">رسائل تسويقية مخصصة تلقائياً.</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div className="w-full flex justify-between items-center text-white/50 text-xs lg:text-sm mt-8">
                ...
                <div className="flex gap-4">
                    ...
                    <a href="#" className="hover:text-white transition-colors duration-200">شروط الخدمة</a>
                </div>
            </div>
        </div>
    );
