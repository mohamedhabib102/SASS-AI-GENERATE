...
import { BarChart, BarChart2, BarChart2Icon, BarChart3Icon, Brush, Menu } from 'lucide-react'
        ...
        <header className='py-4'>
            <div className="container flex justify-between items-center ">
                ...
                <div className="links gap-4 items-center hidden md:flex">
                    {
                        links.map((link, index)=>(
                            <NavLink key={index} to={link.route} className={' text-gray-500 py-2 font-semibold'}>
                                {link.label}
                            </NavLink>
                        ))
                    }
                ...
                <div className='flex gap-4 items-center'>
                    ...
                    <div className="butns">
                        <Button className={'text-white font-medium bg-blue-500 hover:bg-blue-600'}>
