    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-(--sidebar-width) bg-white p-0 text-sidebar-foreground shadow-2xl border-none [&>button]:hidden"
          style={
            {
...
function SidebarContent({
  ...
  return (
    <div
      ...
      className={cn(
        "no-scrollbar flex min-h-0 flex-1 flex-col gap-0 overflow-y-auto overflow-x-visible group-data-[collapsible=icon]:overflow-visible",
        className
      )}
      {...props} />
  );
